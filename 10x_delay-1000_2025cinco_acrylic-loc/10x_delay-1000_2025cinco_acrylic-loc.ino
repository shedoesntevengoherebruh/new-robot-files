...
int delayMove = 500; // the number of MILLISECONDS for delays between MOVEMENTS/directions.... related to wiggle.
bool moveFlag = false;
...
void gen_and_collect(){
  ...
  delay(delayMove);
  for(int movement_iterator=0;movement_iterator<10;movement_iterator++){
